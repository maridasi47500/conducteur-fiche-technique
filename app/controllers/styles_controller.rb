class StylesController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @style.update(style_params)
        format.html { redirect_to @style, notice: "Style was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to styles_path, notice: "Style was successfully destroyed.", status: :see_other }
