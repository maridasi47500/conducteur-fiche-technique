...
class InterpretationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create interpretation" do
    assert_difference("Interpretation.count") do
      post interpretations_url, params: { interpretation: { artistic_truth: @interpretation.artistic_truth, conducteur_id: @interpretation.conducteur_id, human_judgment: @interpretation.human_judgment, machine_analysis: @interpretation.machine_analysis, the_gap: @interpretation.the_gap } }
    end
  ...
  test "should update interpretation" do
    patch interpretation_url(@interpretation), params: { interpretation: { artistic_truth: @interpretation.artistic_truth, conducteur_id: @interpretation.conducteur_id, human_judgment: @interpretation.human_judgment, machine_analysis: @interpretation.machine_analysis, the_gap: @interpretation.the_gap } }
