...
class ZonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create zone" do
    assert_difference("Zone.count") do
      post zones_url, params: { zone: { name: @zone.name, y_max: @zone.y_max, y_min: @zone.y_min } }
    end
  ...
  test "should update zone" do
    patch zone_url(@zone), params: { zone: { name: @zone.name, y_max: @zone.y_max, y_min: @zone.y_min } }
